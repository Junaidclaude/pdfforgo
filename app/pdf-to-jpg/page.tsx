            ...
            {HOW_TO_STEPS.map((step, i) => (
              <div key={i} className="bg-white rounded-2xl p-6 border border-line">
                <div className="w-10 h-10 bg-purple-50 rounded-xl flex items-center justify-center mb-4">
                  <span className="font-display font-bold text-purple-600 text-lg">
                    {i + 1}
                  </span>
                </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {related.map((tool) => (
              ...
              >
                <p className="font-display font-bold text-ink group-hover:text-purple-600 transition-colors">
                  {tool.name}
                </p>
